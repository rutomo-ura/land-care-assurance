...
| AGOL map layer | `publish_regrid_snapshot.py` overwrites item `a4012693d5d74dd8998610c4d235068d` from `gis.regrid_surveys` | Monitoring/KPI runtime can query returned survey evidence from `gisdb_gis_regrid_surveys` |
